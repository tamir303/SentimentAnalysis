...
class MSE(Evaluation):
    ...
    def calculate_score( self, y_true: np.ndarray, y_pred: np.ndarray ) -> float:
        ...
        try:
            ...
            logging.error(f"Exception occurred in calculate_score method of the MSE class. Exception message: {str(e)}")
            raise e
...
class R2Score(Evaluation):
    ...
    def calculate_score( self, y_true: np.ndarray, y_pred: np.ndarray ) -> float:
        ...
        try:
            ...
            logging.error(f"Exception occurred in calculate_score method of the R2Score class. Exception message: {str(e)}")
            raise e
...
class RMSE(Evaluation):
    ...
    def calculate_score( self, y_true: np.ndarray, y_pred: np.ndarray ) -> float:
        ...
        try:
            ...
            logging.error(f"Exception occurred in calculate_score method of the RMSE class. Exception message: {str(e)}")
            raise e
